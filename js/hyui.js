$(function() {
    ...
    .click(function(e) {
        ...
        $('.wrapper').removeClass('large_size').addClass('small_size');
    ...
    .click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.wrapper').removeClass('large_size small_size');
        $(this).blur().addClass('active');
        e.preventDefault();
    ...
    .click(function(e) {
        $(this).parent('li').siblings('li').find('a').removeClass('active');
        $('.wrapper').removeClass('small_size').addClass('large_size');
        $(this).blur().addClass('active');
        e.preventDefault();
    ...
    window.onload = function(e) {
        ...
        if (cookie == 'small') {
            ...
            $('.wrapper').removeClass('large_size medium_size').addClass('small_size');
            ...
            if (cookie == 'large') {
                ...
                $('.wrapper').removeClass('small_size medium_size').addClass('large_size');
